...
public class DDDyeValues {
    public static DyeColor CORAL = DyeColor.byName("DELICATEDYES_CORAL", DyeColor.valueOf("CORAL"));
    ...
    public static DyeColor ROSE = DyeColor.byName("DELICATEDYES_ROSE", DyeColor.valueOf("ROSE"));
}
